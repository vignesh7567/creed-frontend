  ...
  return (
    <div id='products' className=' flex flex-col justify-center items-center pt-[109px] w-[80%]'>
      ...
      <div className=' flex flex-wrap justify-center gap-[20px] mt-[52px] md:mt-[72px]' >
        <img className=' w-[295px]' src={product1} alt='procduct' loading="lazy" />
        <img className=' w-[295px]' src={product2} alt='procduct' loading="lazy" />
        <img className=' w-[295px]' src={product3} alt='procduct' loading="lazy" />
        <img className=' w-[295px]' src={product4} alt='procduct' loading="lazy" />
      </div>
    </div>
  )
}
